...
public class KeyboardManager: NSObject {
    ...
    static public let shared = KeyboardManager()
    ...
    public struct KeyboardOptions {
        ...
        public let animationCurve: UIView.AnimationOptions // 改成自己的实现
...
//                case UIView.AnimationCurve.init(rawValue: <#T##Int#>):
...
//        }
        ...
        return KeyboardOptions(belongsToCurrentApp: currentApp, startFrame: startFrame, endFrame: endFrame, animationCurve: UIView.AnimationOptions(rawValue: UInt(animationOptions)), animationDuration: animationDuration)
    }
...
private extension KeyboardManager.KeyboardEvent {
    ...
    var selector: Selector {
        get {
            switch self {
            case .willShow:
                return #selector(KeyboardManager.keyboardWillShow(note:))
            case .didShow:
                return #selector(KeyboardManager.keyboardDidShow(note:))
            case .willHide:
                return #selector(KeyboardManager.keyboardWillHide(note:))
            case .didHide:
                return #selector(KeyboardManager.keyboardDidHide(note:))
            case .willChangeFrame:
                return #selector(KeyboardManager.keyboardWillChangeFrame(note:))
            case .didChangeFrame:
                return #selector(KeyboardManager.keyboardDidChangeFrame(note:))
            }
        }
    }
}
